package com.gopinath.assignment5;
...
class TicketBooking1 {
 ...
 public TicketBooking1(String stageEvent, String customer, Integer noOfSeats) {
...
public class ticketBooking {
 public static void main(String[] args) {
     ...
     TicketBooking1 booking = new TicketBooking1(stageEvent, customer, noOfSeats);
